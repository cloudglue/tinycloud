...
- The live CDN serves 0.3.16 (latest aliases + v-prefixed pinned tarballs
  for 0.3.0 through 0.3.16, with `manifest.json` + `.sha256`
  sidecars; `channels.stable` = 0.3.16); all smoke legs are required.
